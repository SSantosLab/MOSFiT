...
class Kasen1(SED):
    ...
    def process(self, **kwargs):
        ...
        return {'sample_wavelengths': self._sample_wavelengths, 'seds': seds,'luminosities':self._luminosities, 'weight_geom1': self._weight_geom, 'mass_weight1': self._mass_weight }
